class mbmdXO {
  ...
  /**
     * ```js
     * mbmdXO.toBinary(1, 2) // 0b010000000
     * ```
     */
  ...
  /**
     ...
     */
  render() {
    return mbmdXO.render(this._x, this._o);
  }

  get winner() {
    const x = mbmdXO.check(this._x);
    const o = mbmdXO.check(this._o);
