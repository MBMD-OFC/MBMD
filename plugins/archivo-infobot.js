...
conn.sendFile(m.chat, imagenn, 'mbmd.jpg', creador, m, { quoted: m });
};
...
- ${global.canalwa}
`;
await conn.sendMessage(m.chat, { text: cuentas, contextInfo: { mentionedJid: [m.sender], forwardingScore: 9, externalAdReply: { title: 'MBMD • CUENTAS', body: 'Contactame si hay algo interesante jsjs', thumbnail: imagen, sourceUrl: null, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: m});
};
...
`;
await conn.sendMessage(m.chat, { text: donar, contextInfo: { mentionedJid: [m.sender], forwardingScore: 9, externalAdReply: { title: 'MBMD • PAGOS', body: 'MBMD te dara un regalo al donar.', thumbnail: imagen, sourceUrl: null, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: m});
};
...
- ${global.canalwa}
`;
await conn.sendMessage(m.chat, { text: grupos, contextInfo: { mentionedJid: [m.sender], forwardingScore: 9, externalAdReply: { title: 'MBMD • COMUNIDAD', body: 'Entra y disfruta de nuestra comunidad, usa el bot o diviertete.', thumbnail: imagen, sourceUrl: null, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: m});
};
...
await conn.sendFile(m.chat, imagen, 'mbmd.jpg', info, {quoted: m});
};
