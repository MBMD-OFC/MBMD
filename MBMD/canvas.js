...
export function levelup(teks, level) {
  return new Promise(async (resolve, reject) => {
    ...
    const font = join(__dirname, '../files/font');
    const fontLevel = join(font, '../plugins/kots/level_c.otf');
    const fontTexts = join(font, '../plugins/kots/texts.otf');
    const xtsx = join(__dirname, '../plugins/isLevel.jpg');
