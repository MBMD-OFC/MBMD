...
const genSVG = async ({
  wid = '',
  pp = join(plugins, 'isParticipant.png'),
  title = '',
  name = '',
  text = '',
  background = '',
...
const render = async ({
  wid = '',
  pp = toBase64(readFileSync(join(plugins, 'isParticipant.png')), 'image/png'),
  name = '',
  title = '',
  text = '',
  background = toBase64(readFileSync(join(plugins, 'datass', 'Aesthetic_000.jpeg')), 'image/jpeg'),
} = {}, format = 'png') => {
